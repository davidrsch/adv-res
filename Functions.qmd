...
Con el patrón binario creado por la función infija `%||%`, que usa el lado izquierdo si no es `NULL` y el lado derecho en caso contrario, podemos simplificar aún más `sample()`: \indexc{NULL}
