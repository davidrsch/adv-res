...
-   If you spot a typo, feel free to edit the underlying page and send a pull request. If you've never done this before, the process is very easy:
    ...
    -   Make the changes using GitHub's in-page editor (fixing typos is perfectly adequate).

    -   Include a brief description of your changes in the area below the editor, then propose the file change. If you make significant changes, include the phrase "I assign the copyright of this contribution to Hadley Wickham" - I need this so I can publish the printed book.
